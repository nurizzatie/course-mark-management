<template>
  <div class="grade-predictor">
        ...
        <tr v-for="a in assessments" :key="a.id">
          ...
          <td>
            <input
              ...
              min="0"
            />
            <span v-else class="text-success fw-bold">{{ a.obtained_mark }}</span>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <!-- 🎯 Prediction Button -->
    <button class="btn btn-success mt-2" @click="predictGrade">🎯 Predict</button>
